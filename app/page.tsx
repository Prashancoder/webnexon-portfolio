      ...
      try {
        ...
        const projectsData = querySnapshot.docs.map(doc => {
          ...
          return {
            ...
            category: (data.category || data.Category || "Uncategorized").toLowerCase(),
          ...
          {!searchQuery && (
            <div className="mb-8">
              ...
              <div className="grid grid-cols-2 gap-2 sm:hidden">
                ...
                <MobileTabButton active={activeTab === "SAAS"} onClick={() => setActiveTab("SAAS")}>SAAS</MobileTabButton>
              ...
              <div className="hidden sm:flex justify-center">
                <div className="inline-flex bg-zinc-900/50 border border-zinc-800 rounded-lg p-1">
                  ...
                  <DesktopTabButton active={activeTab === "SAAS"} onClick={() => setActiveTab("SAAS")}>SAAS</DesktopTabButton>
